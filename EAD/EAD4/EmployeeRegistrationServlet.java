...
/*Employee registration servelet
 * To store the details of employees in database
 * 
 * */
public class EmployeeRegistrationServlet extends HttpServlet {
	public void service(HttpServletRequest request, HttpServletResponse responce) throws IOException{
		...
		try {
			...
			out.println("<a href=\"../../../EAD3/VehicleRegistration.jsp\"><div class=\"innerBox\"><h1>Register Vehicle</h1></div></a>");
			out.println("</body>");
			out.println("</html>");
