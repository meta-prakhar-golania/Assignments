...
/*Servlet to show the list of people in organization
 * */
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			while (result.next()) {
				...
				out.println("<tr><td>" + countSequence++ + "</td><td>"+ result.getString("name") + "</td><td>"
						+ result.getString("email") + "</td><td>"+ result.getString("mobile") + "</td><td>"
