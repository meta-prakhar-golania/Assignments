...
/*Servlet for sign in  
  */
	public void service(HttpServletRequest request, HttpServletResponse responce) throws IOException{
		...
		try {
			Connection con = sqlConnection.sqlConnect("ParkingSystem", "root", "123Asdfg12");
			...
			if(!result.next()){
				...
				out.println("<a href=\"../../../EAD3/SignIn.html\"><div class=\"innerBox\"><h1>Sign In</h1></div></a>");
				out.println("<a href=\"../../../EAD3/EmployeeRegistration.html\"><div class=\"innerBox\"><h1>Sign Up</h1></div></a></div>");
			}
			else{
				...
				out.println("<a href=\"../../../EAD3/SelectPass.jsp\"><div class=\"innerBox\"><h1>Select Plan</h1></div></a>");
				out.println("<a href=\"../../../EAD3/HomePage.jsp\"><div class=\"innerBox\"><h1>Home<br> Page</h1></div></a></div>");
			}
			out.println("</div>");
			out.println("</body>");
			out.println("</html>");
