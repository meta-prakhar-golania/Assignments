...
function getPass() {
    ...
    document.getElementById("onclickvehicleform").style.display = "none";
    document.getElementById("onclickfeedbackform").style.display = "none";
    document.getElementById("onclickplanform").style.display = "none";
...
function showregisterform() {
    ...
    document.getElementById("onclickvehicleform").style.display = "block";
    document.getElementById("vehicleformid").style.display = "none";
    document.getElementById("onclickfeedbackform").style.display = "block";
    document.getElementById("feedbackid").style.display = "none";
    document.getElementById("onclickplanform").style.display = "block";
    document.getElementById("planid").style.display = "none";
}

function showvehicleform() {
    document.getElementById("registerformid").style.display = "none";
    document.getElementById("onclickregisterform").style.display = "block";
    document.getElementById("onclickvehicleform").style.display = "none";
